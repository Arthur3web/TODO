...
//   const [CapTodoContainer, setCapTodoContainer] = useState()
...
//   const getCapTodoContainer = () => {
//     const tmp = new Date()
//     tmp.setFullYear(obj.year)
//     tmp.setMonth(obj.month)
//     tmp.setDate(obj.day)
//     setCapTodoContainer(tmp)
//     console.log(tmp)
//   }

//   function getweekday (CapTodoContainer)  {
//     const days = ['ПН','ВТ','СР','ЧТ','ПТ','СБ','ВС'];
//     return setDat(days[CapTodoContainer.getDay()])
...
//     <div>
//     <button onClick={getCapTodoContainer}>AAZAZA</button>
//     </div>
//     {CapTodoContainer && CapTodoContainer.getDay()}
